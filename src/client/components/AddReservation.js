...
export default function AddReservation(props) {
    ...
    return (
        <>
            <form className="AddComponents" action="/api/reservations/" method="POST" target="_blank">
                ...
                <input name="number_of_guests" id="number_of_guests" value={number_of_guests} onChange={handleNumber_of_guests} type="number" min="1" max={props.max_reservations} placeholder="number_of_guests" required></input><br />
                <label for="contact_phonenumber">contact_phonenumber: </label>
                <input name="contact_phonenumber" id="contact_phonenumber" value={contact_phonenumber} onChange={handleContact_phonenumber} placeholder="contact_phonenumber" required></input><br />
                <label for="contact_name">contact_name: </label>
                <input name="contact_name" id="contact_name" value={contact_name} onChange={handleContact_name} placeholder="contact_name" required></input><br />
